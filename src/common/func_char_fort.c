...
void (*LOCAL_f_MPI_Get_processor_name)(char *,int *,int *i,fort_string_length);
...
void  (*LOCAL_f_MPI_Error_string)(int * errorcode,char * string,int * resultlen,int * ret,fort_string_length);
...
void (*LOCAL_f_MPI_File_open)(int *, char*, int*, int*, int*,int*, fort_string_length);
...
void  (*LOCAL_f_MPI_File_set_view)(int *,int*,int *,int *,char *,int *,int *,fort_string_length);
...
void  (*LOCAL_f_MPI_File_get_view)(int *,int*,int *,int *,char *,int*,fort_string_length );
...
void  (*LOCAL_f_MPI_File_delete)(char *,int *,int *,int);
#elif defined(GFORT_CALL) && __GNUC__ >= 8
void  (*LOCAL_f_MPI_File_delete)(char *,int *,int *,size_t);
#endif
#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL) || (defined(GFORT_CALL) && __GNUC__ < 8)
...
void  (*LOCAL_f_MPI_Info_delete)(int *,char *,int *,fort_string_length);
...
void  (*LOCAL_f_MPI_Info_get)(int *,char *,int *,char *,int *,int *,fort_string_length,fort_string_length);
...
void  (*LOCAL_f_MPI_Info_get_nthkey)(int *,int *,char *,int *,fort_string_length);
...
void  (*LOCAL_f_MPI_Info_get_valuelen)(int *,char *,int *,int *,int *,fort_string_length);
...
void  (*LOCAL_f_MPI_Info_set)(int *,char *,char *,int *,fort_string_length,fort_string_length);
...
void  (*LOCAL_f_MPI_Win_get_name)(int *,char *,int *,int*,fort_string_length);
...
void  (*LOCAL_f_MPI_Comm_get_name)(int *,char *,int *,int*,fort_string_length);
...
void  (*LOCAL_f_MPI_Comm_set_name)(int *,char *,int *,fort_string_length);
...
#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL) || (defined(GFORT_CALL) && __GNUC__ < 8)
void  (*LOCAL_f_MPI_Comm_spawn)(char *, char *, int *, int *, int *, int *, int *, int*, int*, int, int);
#elif defined(GFORT_CALL) && __GNUC__ >= 8
void  (*LOCAL_f_MPI_Comm_spawn)(char *, char *, int *, int *, int *, int *, int *, int*, int*, size_t, size_t);
#endif
#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL) || (defined(GFORT_CALL) && __GNUC__ < 8)
...
void  (*LOCAL_f_MPI_Type_get_name)(int *,char *,int *,int*,fort_string_length);
...
void  (*LOCAL_f_MPI_Type_set_name)(int *,char *,int*,fort_string_length);
...
void  (*LOCAL_f_MPI_Add_error_string)(int *,char *,int*,fort_string_length);
...
void  (*LOCAL_f_MPI_Close_port)(char *,int*,fort_string_length);
...
void  (*LOCAL_f_MPI_Get_library_version)(char *,int*,int*,fort_string_length);
...
void  (*LOCAL_f_MPI_Open_port)(int *,char*, int*,fort_string_length);
...
void  (*LOCAL_f_MPI_Publish_name)(char *,int*, char*,int*,fort_string_length,fort_string_length);
...
void  (*LOCAL_f_MPI_Unpublish_name)(char *,int*, char*,int*,fort_string_length,fort_string_length);
...
fstring_max_conv_a2r(port_name, tmp_name, port_name_len, R_MPI_MAX_PORT_NAME-1, false);
 ...
 LOCAL_f_MPI_Unpublish_name(service_name, &info_tmp, tmp_name, &ret_tmp,service_name_len, R_MPI_MAX_PORT_NAME-1);
error_r2a(ret,&ret_tmp);
in_w=0;
#ifdef DEBUG
...
void  (*LOCAL_f_MPI_Win_set_name)(int *, char *, int*, fort_string_length);
...
void  (*LOCAL_f_MPI_Lookup_name)(char*, int*, char *, int*, fort_string_length, fort_string_length);
...
void (*LOCAL_f_MPI_Comm_accept)(char *, int *, int *, int *, int *, int *, fort_string_length);
...
printf("entre : A_f_MPI_Comm_accept\n");
  ...
  char tmp_name[R_MPI_MAX_PORT_NAME-1];
  fstring_max_conv_a2r(port_name, tmp_name, port_name_len, R_MPI_MAX_PORT_NAME-1, false);
  LOCAL_f_MPI_Comm_accept(tmp_name, &info_tmp, &root_tmp, &comm_tmp,
...
void (*LOCAL_f_MPI_Comm_connect)(char *, int *, int *, int *, int *, int *, fort_string_length);
...
#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL) || (defined(GFORT_CALL) && __GNUC__ < 8)
void  (*LOCAL_f_MPI_Pack_external)(char *, void*, int, int*, void*, size_t, size_t *, int *, int);
#elif defined(GFORT_CALL) && __GNUC__ >= 8
void  (*LOCAL_f_MPI_Pack_external)(char *, void*, int, int*, void*, size_t, size_t *, int *, size_t);
#endif
#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL) || (defined(GFORT_CALL) && __GNUC__ < 8)
...
#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL) || (defined(GFORT_CALL) && __GNUC__ < 8)
void  (*LOCAL_f_MPI_Pack_external_size)(char *, int, int *, size_t *, int *, int);
#elif defined(GFORT_CALL) && __GNUC__ >= 8
void  (*LOCAL_f_MPI_Pack_external_size)(char *, int, int *, size_t *, int *, size_t);
#endif
#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL) || (defined(GFORT_CALL) && __GNUC__ < 8)
...
#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL) || (defined(GFORT_CALL) && __GNUC__ < 8)
void  (*LOCAL_f_MPI_Unpack_external)(char *, void *, size_t, size_t *, void *, int, int *, int *, int);
#elif defined(GFORT_CALL) && __GNUC__ >= 8
void  (*LOCAL_f_MPI_Unpack_external)(char *, void *, size_t, size_t *, void *, int, int *, int *, size_t);
#endif
#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL) || (defined(GFORT_CALL) && __GNUC__ < 8)
...
//void  (*LOCAL_f_MPI_Register_datarep)(char **,void*,void*,void*,void *,int *);
//
...
//LOCAL_f_MPI_Abort( &comm, &errorcode, &ret_tmp);
//error_r2a(ret,&ret_tmp);
//in_w=0;
//#ifdef DEBUG
...
//void  (*LOCAL_f_MPI_Comm_spawn_multiple)(char *, char *, int *, int *, int *, int *, int *, int*, int*, int, int);
//#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL)
//void  (*LOCAL_f_MPI_Comm_spawn_multiple)(char *, char *, int *, int *, int *, int *, int *, int*, int*, int, int);
//#elif defined(GFORT_CALL)
//void  (*LOCAL_f_MPI_Comm_spawn_multiple)(char *, int, char *, int, int *, int *, int *, int *, int *, int*, int*);
//#endif
//#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL)
...
//
//#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL)
// LOCAL_f_MPI_Comm_spawn_multiple(command, argv, maxprocs, &info_tmp, &root_tmp,&comm_tmp, &intercomm_tmp, array_of_errcodes, &ret_tmp,command_len,argv_len);
//#elif defined(GFORT_CALL)
// LOCAL_f_MPI_Comm_spawn_multiple(command, command_len, argv,argv_len, maxprocs, &info_tmp, &root_tmp,&comm_tmp, &intercomm_tmp, array_of_errcodes, &ret_tmp);
//#endif
//comm_r2a(intercomm,&intercomm_tmp);
//error_r2a(ret,&ret_tmp);
//in_w=0;
