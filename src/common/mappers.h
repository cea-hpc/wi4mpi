...
static inline void combiner_conv_a2r(int *combiner,int *combiner_tmp)
{
    switch(*combiner)
    {
        case A_MPI_COMBINER_NAMED          : *combiner_tmp = R_MPI_COMBINER_NAMED         ; break;
        case A_MPI_COMBINER_DUP            : *combiner_tmp = R_MPI_COMBINER_DUP           ; break;
        case A_MPI_COMBINER_CONTIGUOUS     : *combiner_tmp = R_MPI_COMBINER_CONTIGUOUS    ; break;
        case A_MPI_COMBINER_VECTOR         : *combiner_tmp = R_MPI_COMBINER_VECTOR        ; break;
        case A_MPI_COMBINER_HVECTOR        : *combiner_tmp = R_MPI_COMBINER_HVECTOR       ; break;
        case A_MPI_COMBINER_INDEXED        : *combiner_tmp = R_MPI_COMBINER_INDEXED       ; break;
        case A_MPI_COMBINER_HINDEXED       : *combiner_tmp = R_MPI_COMBINER_HINDEXED      ; break;
        case A_MPI_COMBINER_INDEXED_BLOCK  : *combiner_tmp = R_MPI_COMBINER_INDEXED_BLOCK ; break;
        case A_MPI_COMBINER_STRUCT         : *combiner_tmp = R_MPI_COMBINER_STRUCT        ; break;
        case A_MPI_COMBINER_DARRAY         : *combiner_tmp = R_MPI_COMBINER_DARRAY        ; break;
        case A_MPI_COMBINER_F90_REAL       : *combiner_tmp = R_MPI_COMBINER_F90_REAL      ; break;
...
static inline void combiner_conv_r2a(int *combiner,int *combiner_tmp)
{
    switch(*combiner_tmp)
    {
...
static inline void datarep_extent_function_converter_a2r(A_MPI_Datarep_extent_function **fa, R_MPI_Datarep_extent_function **fr)
{
    ...
    ((void **)ptr)[1]=(void **)datarep_extent_func_resolved;
    *((void**)fr)=(void*)ptr+0x10;
}
...
static inline void errhandler_ptr_conv_a2r(A_MPI_Errhandler **errhandler, R_MPI_Errhandler **errhandler_tmp)
{
    errhandler_translation_get(**errhandler, *errhandler_tmp);
}
