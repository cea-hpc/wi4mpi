...
/* A_MPIR_ERRORS_THROW_EXCEPTIONS is not part of the MPI standard, it is here to
...
/* the A_MPI_T_ interface requires that these VERBOSITY constants occur in this
