 ...
 * 1.0.7rc1 will have the numeric version 10007201.
 */
#define I_MPI_VERSION "5.1.3"
#define I_MPI_NUMVERSION 50103300
...
extern MPIU_DLL_SPEC int * const MPI_UNWEIGHTED;
extern MPIU_DLL_SPEC int * const MPI_WEIGHTS_EMPTY;
