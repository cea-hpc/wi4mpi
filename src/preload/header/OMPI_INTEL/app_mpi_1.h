...
/* A_MPI datatype corresponding to A_MPI_Offset */
#define OMPI_OFFSET_DATATYPE A_MPI_LONG_LONG
...
/* Whether we want A_MPI cxx support or not */
...
/* Whether we want the A_MPI f77 bindings or not */
#define OMPI_WANT_F77_BINDINGS 1

/* Whether we want the A_MPI f90 bindings or not */
#define OMPI_WANT_F90_BINDINGS 1

/* Enable warnings in wrong usage (e.g. deprecated) in user-level code */
/* XXX This __disabled__ by default for Open A_MPI-1.5, but will be __enabled__ for Open A_MPI-1.7 by default */
/* Users should be notified about this proposed change. */
#ifndef OMPI_WANT_A_MPI_INTERFACE_WARNING
#define OMPI_WANT_A_MPI_INTERFACE_WARNING 0
#endif

/* Whether or not we have compiled with C++ exceptions support */
#define OMPI_HAVE_CXX_EXCEPTION_SUPPORT 0

/* Major, minor, and release version of Open A_MPI */
...
/* Whether OMPI should provide A_MPI File interface */
 ...
 * A_MPI version
 */
#define A_MPI_VERSION 2
#define A_MPI_SUBVERSION 1


/*
 * Do we want A_MPI interface deprecated function warnings?  This is
 * only relevant if we're not building Open A_MPI (i.e., we're compiling an
 * A_MPI application).
 */
#if !(OMPI_BUILDING || \
...
//#    include "mpi_portable_platform.h"
      ...
      * build Open A_MPI, enable compile-time warning of user-level code
...
struct ompi_status_public_t {
    /* These fields are publicly defined in the A_MPI specification.
       User applications may freely read from these fields. */
    int A_MPI_SOURCE;
    int A_MPI_TAG;
    int A_MPI_ERROR;
    /* The following two fields are internal to the Open A_MPI
       implementation and should not be accessed by A_MPI applications.
...
typedef A_MPI_Comm_errhandler_function A_MPI_Comm_errhandler_fn
        __mpi_interface_deprecated__("A_MPI_Comm_errhandler_fn was deprecated in A_MPI-2.2; use A_MPI_Comm_errhandler_function instead");
    ...
    /* This is a little hackish, but errhandler.h needs space for a
       ...
       apps that don't use A_MPI I/O. */
typedef void (ompi_file_errhandler_fn)(A_MPI_File *, int *, ...);
typedef ompi_file_errhandler_fn A_MPI_File_errhandler_fn
        __mpi_interface_deprecated__("A_MPI_File_errhandler_fn was deprecated in A_MPI-2.2; use A_MPI_File_errhandler_function instead");
...
typedef A_MPI_Win_errhandler_function A_MPI_Win_errhandler_fn
        __mpi_interface_deprecated__("A_MPI_Win_errhandler_fn was deprecated in A_MPI-2.2; use A_MPI_Win_errhandler_function instead");
...
#define A_MPI_MAX_NAME_LEN         A_MPI_MAX_PORT_NAME     /* max port name length, non-std. (LAM < 6.3b1) */
...
#if OMPI_PROVIDE_A_MPI_FILE_INTERFACE
/*
 * Since these values are arbitrary to Open A_MPI, we might as well make
...
/*
 * A_MPI-2 One-Sided Communications asserts
 */
...
enum {
    ...
    /* Even though these four are IA_MPI attributes, they need to be there
       for all A_MPI jobs */
    IA_MPI_CLIENT_SIZE,
    IA_MPI_CLIENT_COLOR,
    IA_MPI_HOST_SIZE,
...
/* A_MPI-2 specifies that the name "A_MPI_TYPE_NULL_DELETE_FN" (and all
   ...
   *accessed* through A_MPI_TYPE_NULL_DELETE_FN, but their actual symbol
   ...
   are compiled in Open A_MPI, so we do *not* want these #defines in
...
/* OMPI_DECLSPEC int */ void * OMPI_C_MPI_TYPE_NULL_COPY_FN;/* A_MPI_Datatype datatype,
 ...
 OMPI_DECLSPEC int */ void * OMPI_C_MPI_NULL_DELETE_FN;/* A_MPI_Comm comm, int comm_keyval,
                                           void* attribute_val_out,
                                           void* extra_state )
                                           __mpi_interface_deprecated__("A_MPI_NULL_DELETE_FN is deprecated in A_MPI-2.0"){}
 OMPI_DECLSPEC int */ void * OMPI_C_MPI_NULL_COPY_FN;/* A_MPI_Comm comm, int comm_keyval,
                                         void* extra_state,
                                         void* attribute_val_in,
                                         void* attribute_val_out,
                                         int* flag );
                                         __mpi_interface_deprecated__("A_MPI_NULL_COPY_FN is deprecated in A_MPI-2.0"){}
 OMPI_DECLSPEC int */ void * OMPI_C_MPI_DUP_FN;/* A_MPI_Comm comm, int comm_keyval,
                                   void* extra_state,
                                   void* attribute_val_in,
                                   void* attribute_val_out,
                                   int* flag );
                                   __mpi_interface_deprecated__("A_MPI_DUP_FN is deprecated in A_MPI-2.0"){}
 ...
 * back compatibility between A_MPI library versions.
...
//
//OMPI_DECLSPEC extern struct ompi_predefined_datatype_t ompi_mpi_lb __mpi_interface_deprecated__("A_MPI_LB is deprecated in A_MPI-2.0");
//OMPI_DECLSPEC extern struct ompi_predefined_datatype_t ompi_mpi_ub __mpi_interface_deprecated__("A_MPI_UB is deprecated in A_MPI-2.0");
...
//
///* Optional A_MPI2 datatypes, always declared and defined, but not "exported" as A_MPI_LOGICAL1 */
...
//
///* New datatypes from the A_MPI 2.2 standard */
...
OMPI_DECLSPEC  int A_MPI_Address(void *location, A_MPI_Aint *address)
                               __mpi_interface_deprecated__("A_MPI_Address is superseded by A_MPI_Get_address in A_MPI-2.0");
...
OMPI_DECLSPEC  int A_MPI_Attr_delete(A_MPI_Comm comm, int keyval)
                                   __mpi_interface_deprecated__("A_MPI_Attr_delete is superseded by A_MPI_Comm_delete_attr in A_MPI-2.0");
OMPI_DECLSPEC  int A_MPI_Attr_get(A_MPI_Comm comm, int keyval, void *attribute_val, int *flag)
                                __mpi_interface_deprecated__("A_MPI_Attr_get is superseded by A_MPI_Comm_get_attr in A_MPI-2.0");
OMPI_DECLSPEC  int A_MPI_Attr_put(A_MPI_Comm comm, int keyval, void *attribute_val)
                                __mpi_interface_deprecated__("A_MPI_Attr_put is superseded by A_MPI_Comm_set_attr in A_MPI-2.0");
...
OMPI_DECLSPEC  int A_MPI_Errhandler_create(A_MPI_Handler_function *function,
                                         A_MPI_Errhandler *errhandler)
                                         __mpi_interface_deprecated__("A_MPI_Errhandler_create is superseded by A_MPI_Comm_create_errhandler in A_MPI-2.0");
...
OMPI_DECLSPEC  int A_MPI_Errhandler_get(A_MPI_Comm comm, A_MPI_Errhandler *errhandler)
                                      __mpi_interface_deprecated__("A_MPI_Errhandler_get is superseded by A_MPI_Comm_get_errhandler in A_MPI-2.0");
OMPI_DECLSPEC  int A_MPI_Errhandler_set(A_MPI_Comm comm, A_MPI_Errhandler errhandler)
                                      __mpi_interface_deprecated__("A_MPI_Errhandler_set is superseded by A_MPI_Comm_set_errhandler in A_MPI-2.0");
...
OMPI_DECLSPEC  int A_MPI_Keyval_create(A_MPI_Copy_function *copy_fn,
                                     ...
                                     __mpi_interface_deprecated__("A_MPI_Keyval_create is superseded by A_MPI_Comm_create_keyval in A_MPI-2.0");
OMPI_DECLSPEC  int A_MPI_Keyval_free(int *keyval)
                                   __mpi_interface_deprecated__("A_MPI_Keyval_free is superseded by A_MPI_Comm_free_keyval in A_MPI-2.0");
...
OMPI_DECLSPEC  int A_MPI_Pack_size(int incount, A_MPI_Datatype datatype, A_MPI_Comm comm,
                                 int *size);
OMPI_DECLSPEC  int A_MPI_Pcontrol(const int level, ...);
...
OMPI_DECLSPEC  int A_MPI_Send_init(void *buf, int count, A_MPI_Datatype datatype,
                                 int dest, int tag, A_MPI_Comm comm,
                                 A_MPI_Request *request);
OMPI_DECLSPEC  int A_MPI_Send(void *buf, int count, A_MPI_Datatype datatype, int dest, int tag, A_MPI_Comm comm);
...
OMPI_DECLSPEC  int A_MPI_Type_extent(A_MPI_Datatype type, A_MPI_Aint *extent)
                                   __mpi_interface_deprecated__("A_MPI_Type_extent is superseded by A_MPI_Type_get_extent in A_MPI-2.0");
...
OMPI_DECLSPEC  int A_MPI_Type_hindexed(int count, int array_of_blocklengths[],
                                     A_MPI_Aint array_of_displacements[],
                                     A_MPI_Datatype oldtype, A_MPI_Datatype *newtype)
                                     __mpi_interface_deprecated__("A_MPI_Type_hindexed is superseded by A_MPI_Type_create_hindexed in A_MPI-2.0");
OMPI_DECLSPEC  int A_MPI_Type_hvector(int count, int blocklength, A_MPI_Aint stride,
                                    A_MPI_Datatype oldtype, A_MPI_Datatype *newtype)
                                    __mpi_interface_deprecated__("A_MPI_Type_hvector is superseded by A_MPI_Type_create_hvector in A_MPI-2.0");
...
OMPI_DECLSPEC  int A_MPI_Type_lb(A_MPI_Datatype type, A_MPI_Aint *lb)
                               __mpi_interface_deprecated__("A_MPI_Type_lb is deprecated, use A_MPI_Type_get_extent in A_MPI-2.0");
...
OMPI_DECLSPEC  int A_MPI_Type_struct(int count, int array_of_blocklengths[],
                                   ...
                                   A_MPI_Datatype array_of_types[],
                                   A_MPI_Datatype *newtype)
                                   __mpi_interface_deprecated__("A_MPI_Type_struct is superseded by A_MPI_Type_create_struct in A_MPI-2.0");
OMPI_DECLSPEC  int A_MPI_Type_ub(A_MPI_Datatype mtype, A_MPI_Aint *ub)
                               __mpi_interface_deprecated__("A_MPI_Type_ub is deprecated, use A_MPI_Type_get_extent in A_MPI-2.0");
...
OMPI_DECLSPEC  int A_PMPI_Pack_size(int incount, A_MPI_Datatype datatype, A_MPI_Comm comm,
                                  int *size);
OMPI_DECLSPEC  int A_PMPI_Pcontrol(const int level, ...);
...
/*
 * Conditional A_MPI 2 C++ bindings support.  Include if:
 ...
 */
#if !defined(OMPI_SKIP_A_MPICXX) && OMPI_WANT_CXX_BINDINGS && !OMPI_BUILDING
#if defined(c_plusplus) || defined(__cplusplus)
...
/* ROMIO requires A_MPI implementations to set this to 1 if they provide
