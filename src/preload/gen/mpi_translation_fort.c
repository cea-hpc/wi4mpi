...
void A_f_MPI_Sendrecv(void *sendbuf, int *sendcount, int *sendtype, int *dest,
  ...
  if (WI4MPI_Sendrecv_print)
    debug_printer(
        ...
        recvtype, source, recvtag, comm, status, ret);
#endif
#ifdef TIMEOUT_SUPPORT
  wi4mpi_unset_timeout();
#endif
...
extern unsigned int WI4MPI_Keyval_create_print;
...
extern unsigned int WI4MPI_Keyval_free_print;
...
extern unsigned int WI4MPI_Attr_put_print;
...
extern unsigned int WI4MPI_Attr_get_print;
...
extern unsigned int WI4MPI_Attr_delete_print;
...
extern unsigned int WI4MPI_Errhandler_create_print;
...
extern unsigned int WI4MPI_Errhandler_set_print;
...
extern unsigned int WI4MPI_Errhandler_get_print;
...
extern unsigned int WI4MPI_Errhandler_free_print;
...
void A_f_MPI_Rput(void *origin_addr, int *origin_count, int *origin_datatype,
  ...
  if (WI4MPI_Rput_print)
    debug_printer(
        ...
        "%*d,\nrequest : %*d,\nerror/return : %*d\n}\n",
        origin_addr, origin_count, origin_datatype, target_rank, target_disp,
        target_count, target_datatype, win, request, ret);
#endif
#ifdef TIMEOUT_SUPPORT
  wi4mpi_unset_timeout();
#endif
...
void A_f_MPI_Rget_accumulate(void *origin_addr, int *origin_count,
  ...
  if (WI4MPI_Rget_accumulate_print)
    debug_printer(
        ...
        origin_addr, origin_count, origin_datatype, result_addr, result_count,
        result_datatype, target_rank, target_disp, target_count,
        target_datatype, op, win, request, ret);
#endif
#ifdef TIMEOUT_SUPPORT
  wi4mpi_unset_timeout();
#endif
...
extern unsigned int WI4MPI_Comm_create_errhandler_print;
...
extern unsigned int WI4MPI_Comm_get_errhandler_print;
...
extern unsigned int WI4MPI_Comm_set_errhandler_print;
...
extern unsigned int WI4MPI_Info_free_print;
...
void A_f_MPI_Waitsome(int *incount, int *array_of_requests, int *outcount,
  ...
  if (WI4MPI_Waitsome_print)
    debug_printer("MPI_Waitsome : \n{\nincount : %*d,\narray_of_requests : "
                  ...
                  array_of_indices, incount, array_of_statuses, ret);
#endif
#ifdef TIMEOUT_SUPPORT
  wi4mpi_unset_timeout();
#endif
...
void A_f_MPI_Cart_get(int *comm, int *maxdims, int *dims, int *periods,
  ...
  if (WI4MPI_Cart_get_print)
    debug_printer(
        "MPI_Cart_get : \n{\ncomm : %*C,\nmaxdims : %*d,\ndims : %*d,\nperiods "
        ": %*d,\ncoords : %*d,\nerror/return : %*d\n}\n",
        comm, maxdims, maxdims, dims, maxdims, periods, maxdims, coords, ret);
#endif
#ifdef TIMEOUT_SUPPORT
  wi4mpi_unset_timeout();
#endif
...
void A_f_MPI_Type_get_contents(int *datatype, int *max_integers,
  ...
  if (WI4MPI_Type_get_contents_print)
    debug_printer("MPI_Type_get_contents : \n{\ndatatype : %*D,\nmax_integers "
                  ...
                  array_of_addresses, max_datatypes, array_of_datatypes, ret);
#endif
#ifdef TIMEOUT_SUPPORT
  wi4mpi_unset_timeout();
#endif
...
void A_f_MPI_Type_create_darray(int *size, int *rank, int *ndims,
  ...
  if (WI4MPI_Type_create_darray_print)
    debug_printer(
        ...
        "%*d,\noldtype : %*D,\nnewtype : %*d,\nerror/return : %*d\n}\n",
        size, rank, ndims, array_of_gsizes, array_of_distribs, array_of_dargs,
        array_of_psizes, order, oldtype, newtype, ret);
#endif
#ifdef TIMEOUT_SUPPORT
  wi4mpi_unset_timeout();
#endif
...
void A_f_MPI_Type_create_indexed_block(int *count, int *blocklength,
  ...
  if (WI4MPI_Type_create_indexed_block_print)
    debug_printer(
        ...
        "%*d,\narray_of_displacements : %*d,\noldtype : %*D,\nnewtype : "
        "%*d,\nerror/return : %*d\n}\n",
        count, blocklength, count, array_of_displacements, oldtype, newtype,
        ret);
#endif
#ifdef TIMEOUT_SUPPORT
  wi4mpi_unset_timeout();
...
void A_f_MPI_Type_create_subarray(int *ndims, int *array_of_sizes,
  ...
  if (WI4MPI_Type_create_subarray_print)
    debug_printer(
        ...
        "%*d,\narray_of_subsizes : %*d,\narray_of_starts : %*d,\norder : "
        "%*d,\noldtype : %*D,\nnewtype : %*d,\nerror/return : %*d\n}\n",
        ndims, ndims, array_of_sizes, ndims, array_of_subsizes, array_of_starts,
        order, oldtype, newtype, ret);
#endif
#ifdef TIMEOUT_SUPPORT
  wi4mpi_unset_timeout();
#endif
...
void A_f_MPI_Dist_graph_create(int *comm_old, int *n, int *sources,
  ...
  if (WI4MPI_Dist_graph_create_print)
    debug_printer(
        ...
        "%*d,\ndegrees : %*d,\ndestinations : %*d,\nweights : %*d,\ninfo : "
        "%*d,\nreorder : %*d,\ncomm_dist_graph : %*C,\nerror/return : %*d\n}\n",
        comm_old, n, n, sources, n, degrees, n, destinations, weights, info,
...
void A_f_MPI_Ineighbor_alltoallw(void *sendbuf, int *sendcounts,
  ...
  if (WI4MPI_Ineighbor_alltoallw_print)
    debug_printer("MPI_Ineighbor_alltoallw : \n{\nsendbuf : %p,\nsendcounts : "
                  ...
                  rdispls, recvtypes, comm, request, ret);
#endif
#ifdef TIMEOUT_SUPPORT
  wi4mpi_unset_timeout();
#endif
...
void A_f_MPI_Neighbor_alltoallw(void *sendbuf, int *sendcounts, size_t *sdispls,
  ...
  if (WI4MPI_Neighbor_alltoallw_print)
    debug_printer("MPI_Neighbor_alltoallw : \n{\nsendbuf : %p,\nsendcounts : "
                  ...
                  recvcounts, rdispls, indegree, recvtypes, comm, ret);
#endif
#ifdef TIMEOUT_SUPPORT
  wi4mpi_unset_timeout();
#endif
