...
OMPI_DECLSPEC  int R_MPI_Accumulate(const void *origin_addr, int origin_count, R_MPI_Datatype origin_datatype,
...
OMPI_DECLSPEC  int R_MPI_Add_error_string(int errorcode, const char *string);
...
OMPI_DECLSPEC  int R_MPI_Allgather(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                 void *recvbuf, int recvcount,
                                 R_MPI_Datatype recvtype, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Iallgather(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                 void *recvbuf, int recvcount,
                                 R_MPI_Datatype recvtype, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Allgatherv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                  void *recvbuf, const int recvcounts[],
                                  const int displs[], R_MPI_Datatype recvtype, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Iallgatherv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                  void *recvbuf, const int recvcounts[],
                                  const int displs[], R_MPI_Datatype recvtype, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Alloc_mem(R_MPI_Aint size, R_MPI_Info info,
                                 void *baseptr);
OMPI_DECLSPEC  int R_MPI_Allreduce(const void *sendbuf, void *recvbuf, int count,
                                 R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Iallreduce(const void *sendbuf, void *recvbuf, int count,
                                 R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Alltoall(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                void *recvbuf, int recvcount,
                                R_MPI_Datatype recvtype, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Ialltoall(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                void *recvbuf, int recvcount,
                                R_MPI_Datatype recvtype, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Alltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[],
                                 R_MPI_Datatype sendtype, void *recvbuf, const int recvcounts[],
                                 const int rdispls[], R_MPI_Datatype recvtype, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Ialltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[],
                                 R_MPI_Datatype sendtype, void *recvbuf, const int recvcounts[],
                                 const int rdispls[], R_MPI_Datatype recvtype, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Alltoallw(const void *sendbuf, const int sendcounts[], const int sdispls[], const R_MPI_Datatype sendtypes[],
                                 void *recvbuf, const int recvcounts[], const int rdispls[], const R_MPI_Datatype recvtypes[],
                                 R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Ialltoallw(const void *sendbuf, const int sendcounts[], const int sdispls[], const R_MPI_Datatype sendtypes[],
                                 void *recvbuf, const int recvcounts[], const int rdispls[], const R_MPI_Datatype recvtypes[],
...
OMPI_DECLSPEC  int R_MPI_Bsend(const void *buf, int count, R_MPI_Datatype datatype,
...
OMPI_DECLSPEC  int R_MPI_Bsend_init(const void *buf, int count, R_MPI_Datatype datatype,
...
OMPI_DECLSPEC  int R_MPI_Cart_create(R_MPI_Comm old_comm, int ndims, const int dims[],
                                   const int periods[], int reorder, R_MPI_Comm *comm_cart);
OMPI_DECLSPEC  int R_MPI_Cart_get(R_MPI_Comm comm, int maxdims, int dims[],
                                int periods[], int coords[]);
OMPI_DECLSPEC  int R_MPI_Cart_map(R_MPI_Comm comm, int ndims, const int dims[],
                                const int periods[], int *newrank);
OMPI_DECLSPEC  int R_MPI_Cart_rank(R_MPI_Comm comm, const int coords[], int *rank);
OMPI_DECLSPEC  int R_MPI_Cart_shift(R_MPI_Comm comm, int direction, int disp,
                                  int *rank_source, int *rank_dest);
OMPI_DECLSPEC  int R_MPI_Cart_sub(R_MPI_Comm comm, const int remain_dims[], R_MPI_Comm *new_comm);
OMPI_DECLSPEC  int R_MPI_Cartdim_get(R_MPI_Comm comm, int *ndims);
OMPI_DECLSPEC  int R_MPI_Close_port(const char *port_name);
OMPI_DECLSPEC  int R_MPI_Comm_accept(const char *port_name, R_MPI_Info info, int root,
...
OMPI_DECLSPEC  int R_MPI_Comm_connect(const char *port_name, R_MPI_Info info, int root,
                                    R_MPI_Comm comm, R_MPI_Comm *newcomm);
...
OMPI_DECLSPEC  int R_MPI_Dist_graph_create(R_MPI_Comm comm_old, int n, const int nodes[],
                                         const int degrees[], const int targets[],
                                         const int weights[], R_MPI_Info info,
...
OMPI_DECLSPEC  int R_MPI_Comm_set_name(R_MPI_Comm comm, const char *comm_name);
OMPI_DECLSPEC  int R_MPI_Comm_size(R_MPI_Comm comm, int *size);
OMPI_DECLSPEC  int R_MPI_Comm_spawn(const char *command, char *argv[], int maxprocs, R_MPI_Info info,
...
OMPI_DECLSPEC  int R_MPI_Comm_spawn_multiple(int count, char *array_of_commands[], char **array_of_argv[],
                                           const int array_of_maxprocs[], const R_MPI_Info array_of_info[],
                                           int root, R_MPI_Comm comm, R_MPI_Comm *intercomm,
                                           int array_of_errcodes[]);
...
OMPI_DECLSPEC  int R_MPI_Exscan(const void *sendbuf, void *recvbuf, int count,
                              R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm);
...
OMPI_DECLSPEC  int R_MPI_Iexscan(const void *sendbuf, void *recvbuf, int count,
                              R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm, R_MPI_Request *request);
#if OMPI_PROVIDE_R_MPI_FILE_INTERFACE
...
OMPI_DECLSPEC  int R_MPI_File_open(R_MPI_Comm comm, const char *filename, int amode,
                                 R_MPI_Info info, R_MPI_File *fh);
OMPI_DECLSPEC  int R_MPI_File_close(R_MPI_File *fh);
OMPI_DECLSPEC  int R_MPI_File_delete(const char *filename, R_MPI_Info info);
...
OMPI_DECLSPEC  int R_MPI_File_set_view(R_MPI_File fh, R_MPI_Offset disp, R_MPI_Datatype etype,
                                     R_MPI_Datatype filetype, const char *datarep, R_MPI_Info info);
...
OMPI_DECLSPEC  int R_MPI_File_read_at_all(R_MPI_File fh, R_MPI_Offset offset, void *buf,
                                        int count, R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_MPI_File_write_at(R_MPI_File fh, R_MPI_Offset offset, const void *buf,
                                     int count, R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_MPI_File_write_at_all(R_MPI_File fh, R_MPI_Offset offset, const void *buf,
                                         int count, R_MPI_Datatype datatype, R_MPI_Status *status);
...
OMPI_DECLSPEC  int R_MPI_File_iwrite_at(R_MPI_File fh, R_MPI_Offset offset, const void *buf,
                                      int count, R_MPI_Datatype datatype, R_MPI_Request *request);
...
OMPI_DECLSPEC  int R_MPI_File_read_all(R_MPI_File fh, void *buf, int count,
                                     R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_MPI_File_write(R_MPI_File fh, const void *buf, int count,
                                  R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_MPI_File_write_all(R_MPI_File fh, const void *buf, int count,
                                      R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_MPI_File_iread(R_MPI_File fh, void *buf, int count,
                                  R_MPI_Datatype datatype, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_File_iwrite(R_MPI_File fh, const void *buf, int count,
                                   R_MPI_Datatype datatype, R_MPI_Request *request);
...
OMPI_DECLSPEC  int R_MPI_File_read_shared(R_MPI_File fh, void *buf, int count,
                                        R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_MPI_File_write_shared(R_MPI_File fh, const void *buf, int count,
					 R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_MPI_File_iread_shared(R_MPI_File fh, void *buf, int count,
                                         R_MPI_Datatype datatype, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_File_iwrite_shared(R_MPI_File fh, const void *buf, int count,
                                          R_MPI_Datatype datatype, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_File_read_ordered(R_MPI_File fh, void *buf, int count,
                                         R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_MPI_File_write_ordered(R_MPI_File fh, const void *buf, int count,
                                          R_MPI_Datatype datatype, R_MPI_Status *status);
...
OMPI_DECLSPEC  int R_MPI_File_write_at_all_begin(R_MPI_File fh, R_MPI_Offset offset, const void *buf,
                                               int count, R_MPI_Datatype datatype);
OMPI_DECLSPEC  int R_MPI_File_write_at_all_end(R_MPI_File fh, const void *buf, R_MPI_Status *status);
...
OMPI_DECLSPEC  int R_MPI_File_write_all_begin(R_MPI_File fh, const void *buf, int count,
                                            R_MPI_Datatype datatype);
OMPI_DECLSPEC  int R_MPI_File_write_all_end(R_MPI_File fh, const void *buf, R_MPI_Status *status);
...
OMPI_DECLSPEC  int R_MPI_File_write_ordered_begin(R_MPI_File fh, const void *buf, int count,
                                                R_MPI_Datatype datatype);
OMPI_DECLSPEC  int R_MPI_File_write_ordered_end(R_MPI_File fh, const void *buf, R_MPI_Status *status);
...
OMPI_DECLSPEC  int R_MPI_Gather(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                              void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                              int root, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Igather(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                              void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                              int root, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Gatherv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                               void *recvbuf, const int recvcounts[], const int displs[],
                               R_MPI_Datatype recvtype, int root, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Igatherv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                               void *recvbuf, const int recvcounts[], const int displs[],
                               R_MPI_Datatype recvtype, int root, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Get_address(const void *location, R_MPI_Aint *address);
OMPI_DECLSPEC  int R_MPI_Get_count(const R_MPI_Status *status, R_MPI_Datatype datatype, int *count);
OMPI_DECLSPEC  int R_MPI_Get_elements(const R_MPI_Status *status, R_MPI_Datatype datatype, int *count);
OMPI_DECLSPEC  int R_MPI_Get_elements_x(const R_MPI_Status *status, R_MPI_Datatype datatype, R_MPI_Count *count);
...
OMPI_DECLSPEC  int R_MPI_Get_accumulate(const void *origin_addr, int origin_count, R_MPI_Datatype origin_datatype,
...
OMPI_DECLSPEC  int R_MPI_Graph_create(R_MPI_Comm comm_old, int nnodes, const int index[],
                                    const int edges[], int reorder, R_MPI_Comm *comm_graph);
OMPI_DECLSPEC  int R_MPI_Graph_get(R_MPI_Comm comm, int maxindex, int maxedges,
                                 int index[], int edges[]);
OMPI_DECLSPEC  int R_MPI_Graph_map(R_MPI_Comm comm, int nnodes, const int index[], const int edges[],
                                 int *newrank);
...
OMPI_DECLSPEC  int R_MPI_Group_excl(R_MPI_Group group, int n, const int ranks[],
                                  R_MPI_Group *newgroup);
OMPI_DECLSPEC  R_MPI_Group R_MPI_Group_f2c(R_MPI_Fint group);
OMPI_DECLSPEC  int R_MPI_Group_free(R_MPI_Group *group);
OMPI_DECLSPEC  int R_MPI_Group_incl(R_MPI_Group group, int n, const int ranks[],
                                  R_MPI_Group *newgroup);
...
OMPI_DECLSPEC  int R_MPI_Group_translate_ranks(R_MPI_Group group1, int n, const int ranks1[],
                                             R_MPI_Group group2, int ranks2[]);
OMPI_DECLSPEC  int R_MPI_Group_union(R_MPI_Group group1, R_MPI_Group group2,
                                   R_MPI_Group *newgroup);
OMPI_DECLSPEC  int R_MPI_Ibsend(const void *buf, int count, R_MPI_Datatype datatype, int dest,
...
OMPI_DECLSPEC  int R_MPI_Info_delete(R_MPI_Info info, const char *key);
...
OMPI_DECLSPEC  int R_MPI_Info_get(R_MPI_Info info, const char *key, int valuelen,
                                char *value, int *flag);
...
OMPI_DECLSPEC  int R_MPI_Info_get_valuelen(R_MPI_Info info, const char *key, int *valuelen,
                                         int *flag);
OMPI_DECLSPEC  int R_MPI_Info_set(R_MPI_Info info, const char *key, const char *value);
...
OMPI_DECLSPEC  int R_MPI_Irecv(void *buf, int count, R_MPI_Datatype datatype, int source,
                             int tag, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Irsend(const void *buf, int count, R_MPI_Datatype datatype, int dest,
                              int tag, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Isend(const void *buf, int count, R_MPI_Datatype datatype, int dest,
                             int tag, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Issend(const void *buf, int count, R_MPI_Datatype datatype, int dest,
                              int tag, R_MPI_Comm comm, R_MPI_Request *request);
...
OMPI_DECLSPEC  int R_MPI_Lookup_name(const char *service_name, R_MPI_Info info, char *port_name);
...
OMPI_DECLSPEC  int R_MPI_Neighbor_allgather(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                          void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                                          R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Ineighbor_allgather(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                           void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                                           R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Neighbor_allgatherv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                           void *recvbuf, const int recvcounts[], const int displs[],
                                           R_MPI_Datatype recvtype, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Ineighbor_allgatherv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                            void *recvbuf, const int recvcounts[], const int displs[],
                                            R_MPI_Datatype recvtype, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Neighbor_alltoall(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                         void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                                         R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Ineighbor_alltoall(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                          void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                                          R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Neighbor_alltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[],  R_MPI_Datatype sendtype,
                                          void *recvbuf, const int recvcounts[], const int rdispls[], R_MPI_Datatype recvtype,
                                          R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Ineighbor_alltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[], R_MPI_Datatype sendtype,
                                           void *recvbuf, const int recvcounts[], const int rdispls[], R_MPI_Datatype recvtype,
                                           R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Neighbor_alltoallw(const void *sendbuf, const int sendcounts[], const R_MPI_Aint sdispls[], const R_MPI_Datatype sendtypes[],
                                          void *recvbuf, const int recvcounts[], const R_MPI_Aint rdispls[], const R_MPI_Datatype recvtypes[],
                                          R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Ineighbor_alltoallw(const void *sendbuf, const int sendcounts[], const R_MPI_Aint sdispls[], const R_MPI_Datatype sendtypes[],
                                           void *recvbuf, const int recvcounts[], const R_MPI_Aint rdispls[], const R_MPI_Datatype recvtypes[],
                                           R_MPI_Comm comm, R_MPI_Request *request);
...
OMPI_DECLSPEC  int R_MPI_Pack_external(const char datarep[], const void *inbuf, int incount,
                                     R_MPI_Datatype datatype, void *outbuf,
                                     R_MPI_Aint outsize, R_MPI_Aint *position);
OMPI_DECLSPEC  int R_MPI_Pack_external_size(const char datarep[], int incount,
                                          R_MPI_Datatype datatype, R_MPI_Aint *size);
OMPI_DECLSPEC  int R_MPI_Pack(const void *inbuf, int incount, R_MPI_Datatype datatype,
...
OMPI_DECLSPEC  int R_MPI_Publish_name(const char *service_name, R_MPI_Info info,
                                    const char *port_name);
OMPI_DECLSPEC  int R_MPI_Put(const void *origin_addr, int origin_count, R_MPI_Datatype origin_datatype,
                           int target_rank, R_MPI_Aint target_disp, int target_count,
                           R_MPI_Datatype target_datatype, R_MPI_Win win);
...
OMPI_DECLSPEC  int R_MPI_Reduce(const void *sendbuf, void *recvbuf, int count,
                              R_MPI_Datatype datatype, R_MPI_Op op, int root, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Ireduce(const void *sendbuf, void *recvbuf, int count,
                              R_MPI_Datatype datatype, R_MPI_Op op, int root, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Reduce_local(const void *inbuf, void *inoutbuf, int count,
                                    R_MPI_Datatype datatype, R_MPI_Op op);
OMPI_DECLSPEC  int R_MPI_Reduce_scatter(const void *sendbuf, void *recvbuf, const int recvcounts[],
                                      R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Ireduce_scatter(const void *sendbuf, void *recvbuf, const int recvcounts[],
                                      R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Reduce_scatter_block(const void *sendbuf, void *recvbuf, int recvcount,
                                      R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Ireduce_scatter_block(const void *sendbuf, void *recvbuf, int recvcount,
                                      R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Register_datarep(const char *datarep,
...
OMPI_DECLSPEC  int R_MPI_Rget_accumulate(const void *origin_addr, int origin_count, R_MPI_Datatype origin_datatype,
                                       void *result_addr, int result_count, R_MPI_Datatype result_datatype,
                                       int target_rank, R_MPI_Aint target_disp, int target_count, 
                                       R_MPI_Datatype target_datatype, R_MPI_Op op,
                                       R_MPI_Win win, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Rput(const void *origin_addr, int origin_count, R_MPI_Datatype origin_datatype,
                            int target_rank, R_MPI_Aint target_disp, int target_cout, 
                            R_MPI_Datatype target_datatype, R_MPI_Win win, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Rsend(const void *ibuf, int count, R_MPI_Datatype datatype, int dest,
                             int tag, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Rsend_init(const void *buf, int count, R_MPI_Datatype datatype,
                                  int dest, int tag, R_MPI_Comm comm,
                                  R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Scan(const void *sendbuf, void *recvbuf, int count,
                            R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Iscan(const void *sendbuf, void *recvbuf, int count,
                            R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Scatter(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                               void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                               int root, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Iscatter(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                               void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                               int root, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Scatterv(const void *sendbuf, const int sendcounts[], const int displs[],
                                R_MPI_Datatype sendtype, void *recvbuf, int recvcount,
                                R_MPI_Datatype recvtype, int root, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Iscatterv(const void *sendbuf, const int sendcounts[], const int displs[],
                                R_MPI_Datatype sendtype, void *recvbuf, int recvcount,
                                R_MPI_Datatype recvtype, int root, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Send_init(const void *buf, int count, R_MPI_Datatype datatype,
                                 int dest, int tag, R_MPI_Comm comm,
                                 R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Send(const void *buf, int count, R_MPI_Datatype datatype, int dest,
                            int tag, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Sendrecv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
...
OMPI_DECLSPEC  int R_MPI_Sendrecv_replace(void * buf, int count, R_MPI_Datatype datatype,
                                        ...
                                        R_MPI_Comm comm, R_MPI_Status *status);
OMPI_DECLSPEC  int R_MPI_Ssend_init(const void *buf, int count, R_MPI_Datatype datatype,
                                  int dest, int tag, R_MPI_Comm comm,
                                  R_MPI_Request *request);
OMPI_DECLSPEC  int R_MPI_Ssend(const void *buf, int count, R_MPI_Datatype datatype, int dest,
                             int tag, R_MPI_Comm comm);
...
OMPI_DECLSPEC  int R_MPI_Status_c2f(const R_MPI_Status *c_status, R_MPI_Fint *f_status);
OMPI_DECLSPEC  int R_MPI_Status_f2c(const R_MPI_Fint *f_status, R_MPI_Status *c_status);
...
OMPI_DECLSPEC  int R_MPI_Test_cancelled(const R_MPI_Status *status, int *flag);
...
OMPI_DECLSPEC  int R_MPI_Type_create_hindexed_block(int count, int blocklength,
                                                  const R_MPI_Aint array_of_displacements[],
                                                  R_MPI_Datatype oldtype,
                                                  R_MPI_Datatype *newtype);
OMPI_DECLSPEC  int R_MPI_Type_create_hindexed(int count, const int array_of_blocklengths[],
                                            const R_MPI_Aint array_of_displacements[],
                                            R_MPI_Datatype oldtype,
                                            R_MPI_Datatype *newtype);
...
OMPI_DECLSPEC  int R_MPI_Type_create_indexed_block(int count, int blocklength,
                                                 ...
                                                 R_MPI_Datatype oldtype,
                                                 R_MPI_Datatype *newtype);
OMPI_DECLSPEC  int R_MPI_Type_create_struct(int count, const int array_of_block_lengths[],
                                          const R_MPI_Aint array_of_displacements[],
                                          const R_MPI_Datatype array_of_types[],
                                          R_MPI_Datatype *newtype);
OMPI_DECLSPEC  int R_MPI_Type_create_subarray(int ndims, const int size_array[], const int subsize_array[],
...
OMPI_DECLSPEC  int R_MPI_Type_indexed(int count, const int array_of_blocklengths[],
                                    const int array_of_displacements[],
                                    R_MPI_Datatype oldtype, R_MPI_Datatype *newtype);
...
OMPI_DECLSPEC  int R_MPI_Type_set_attr(R_MPI_Datatype type, int type_keyval,
                                     void *attr_val);
OMPI_DECLSPEC  int R_MPI_Type_set_name(R_MPI_Datatype type, const char *type_name);
...
OMPI_DECLSPEC  int R_MPI_Type_vector(int count, int blocklength, int stride,
                                   R_MPI_Datatype oldtype, R_MPI_Datatype *newtype);
OMPI_DECLSPEC  int R_MPI_Unpack(const void *inbuf, int insize, int *position,
                              void *outbuf, int outcount, R_MPI_Datatype datatype,
                              R_MPI_Comm comm);
OMPI_DECLSPEC  int R_MPI_Unpublish_name(const char *service_name, R_MPI_Info info, const char *port_name);
OMPI_DECLSPEC  int R_MPI_Unpack_external (const char datarep[], const void *inbuf, R_MPI_Aint insize,
...
OMPI_DECLSPEC  int R_MPI_Win_set_name(R_MPI_Win win, const char *win_name);
...
OMPI_DECLSPEC  int R_PMPI_Accumulate(const void *origin_addr, int origin_count, R_MPI_Datatype origin_datatype,
                                   int target_rank, R_MPI_Aint target_disp, int target_count,
                                   R_MPI_Datatype target_datatype, R_MPI_Op op, R_MPI_Win win);
...
OMPI_DECLSPEC  int R_PMPI_Add_error_string(int errorcode, const char *string);
OMPI_DECLSPEC  int R_PMPI_Address(void *location, R_MPI_Aint *address)
                                __mpi_interface_deprecated__("R_MPI_Address is superseded by R_MPI_Get_address in MPI-2.0");
OMPI_DECLSPEC  int R_PMPI_Allgather(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                  void *recvbuf, int recvcount,
                                  R_MPI_Datatype recvtype, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Iallgather(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                  void *recvbuf, int recvcount,
                                  R_MPI_Datatype recvtype, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Allgatherv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                   void *recvbuf, const int recvcounts[],
                                   const int displs[], R_MPI_Datatype recvtype, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Iallgatherv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                   void *recvbuf, const int recvcounts[],
                                   const int displs[], R_MPI_Datatype recvtype, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Alloc_mem(R_MPI_Aint size, R_MPI_Info info,
                                  void *baseptr);
OMPI_DECLSPEC  int R_PMPI_Allreduce(const void *sendbuf, void *recvbuf, int count,
                                  R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Iallreduce(const void *sendbuf, void *recvbuf, int count,
                                  R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Alltoall(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                 void *recvbuf, int recvcount,
                                 R_MPI_Datatype recvtype, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Ialltoall(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                 void *recvbuf, int recvcount,
                                 R_MPI_Datatype recvtype, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Alltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[],
                                  R_MPI_Datatype sendtype, void *recvbuf, const int recvcounts[],
                                  const int rdispls[], R_MPI_Datatype recvtype, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Ialltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[],
                                  R_MPI_Datatype sendtype, void *recvbuf, const int recvcounts[],
                                  const int rdispls[], R_MPI_Datatype recvtype, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Alltoallw(const void *sendbuf, const int sendcounts[], const int sdispls[], const R_MPI_Datatype sendtypes[],
                                  void *recvbuf, const int recvcounts[], const int rdispls[], const R_MPI_Datatype recvtypes[],
                                  R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Ialltoallw(const void *sendbuf, const int sendcounts[], const int sdispls[], const R_MPI_Datatype sendtypes[],
                                  void *recvbuf, const int recvcounts[], const int rdispls[], const R_MPI_Datatype recvtypes[],
                                  R_MPI_Comm comm, R_MPI_Request *request);
...
OMPI_DECLSPEC  int R_PMPI_Attr_get(R_MPI_Comm comm, int keyval, void *attribute_val, int *flag)
                                 __mpi_interface_deprecated__("R_MPI_Attr_get is superseded by R_MPI_Comm_get_attr in MPI-2.0");
OMPI_DECLSPEC  int R_PMPI_Dist_graph_create(R_MPI_Comm comm_old, int n, const int nodes[],
                                          const int degrees[], const int targets[],
                                          const int weights[], R_MPI_Info info,
                                          int reorder, R_MPI_Comm * newcomm);
...
OMPI_DECLSPEC  int R_PMPI_Ibcast(void *buffer, int count, R_MPI_Datatype datatype,
				                              int root, R_MPI_Comm comm,
											  R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Bsend(const void *buf, int count, R_MPI_Datatype datatype,
                              int dest, int tag, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Bsend_init(const void *buf, int count, R_MPI_Datatype datatype,
                                   int dest, int tag, R_MPI_Comm comm, R_MPI_Request *request);
...
OMPI_DECLSPEC  int R_PMPI_Cart_create(R_MPI_Comm old_comm, int ndims, const int dims[],
                                    const int periods[], int reorder, R_MPI_Comm *comm_cart);
OMPI_DECLSPEC  int R_PMPI_Cart_get(R_MPI_Comm comm, int maxdims, int dims[],
                                 int periods[], int coords[]);
OMPI_DECLSPEC  int R_PMPI_Cart_map(R_MPI_Comm comm, int ndims, const int dims[],
                                 const int periods[], int *newrank);
OMPI_DECLSPEC  int R_PMPI_Cart_rank(R_MPI_Comm comm, const int coords[], int *rank);
OMPI_DECLSPEC  int R_PMPI_Cart_shift(R_MPI_Comm comm, int direction, int disp,
                                   int *rank_source, int *rank_dest);
OMPI_DECLSPEC  int R_PMPI_Cart_sub(R_MPI_Comm comm, const int remain_dims[], R_MPI_Comm *new_comm);
OMPI_DECLSPEC  int R_PMPI_Cartdim_get(R_MPI_Comm comm, int *ndims);
OMPI_DECLSPEC  int R_PMPI_Close_port(const char *port_name);
OMPI_DECLSPEC  int R_PMPI_Comm_accept(const char *port_name, R_MPI_Info info, int root,
                                    R_MPI_Comm comm, R_MPI_Comm *newcomm);
...
OMPI_DECLSPEC  int R_PMPI_Comm_connect(const char *port_name, R_MPI_Info info, int root,
                                     R_MPI_Comm comm, R_MPI_Comm *newcomm);
...
OMPI_DECLSPEC  int R_PMPI_Comm_set_name(R_MPI_Comm comm, const char *comm_name);
OMPI_DECLSPEC  int R_PMPI_Comm_size(R_MPI_Comm comm, int *size);
OMPI_DECLSPEC  int R_PMPI_Comm_spawn(const char *command, char *argv[], int maxprocs, R_MPI_Info info,
                                   int root, R_MPI_Comm comm, R_MPI_Comm *intercomm,
                                   int array_of_errcodes[]);
...
OMPI_DECLSPEC  int R_PMPI_Exscan(const void *sendbuf, void *recvbuf, int count,
                               R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Fetch_and_op(void *origin_addr, void *result_addr, R_MPI_Datatype datatype,
                                     int target_rank, R_MPI_Aint target_disp, R_MPI_Op op, R_MPI_Win win);
OMPI_DECLSPEC  int R_PMPI_Iexscan(const void *sendbuf, void *recvbuf, int count,
                               R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm, R_MPI_Request *request);
#if OMPI_PROVIDE_R_MPI_FILE_INTERFACE
...
OMPI_DECLSPEC  int R_PMPI_File_open(R_MPI_Comm comm, const char *filename, int amode,
                                  R_MPI_Info info, R_MPI_File *fh);
OMPI_DECLSPEC  int R_PMPI_File_close(R_MPI_File *fh);
OMPI_DECLSPEC  int R_PMPI_File_delete(const char *filename, R_MPI_Info info);
...
OMPI_DECLSPEC  int R_PMPI_File_read_at_all(R_MPI_File fh, R_MPI_Offset offset, void *buf,
                                         int count, R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_File_write_at(R_MPI_File fh, R_MPI_Offset offset, const void *buf,
                                      int count, R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_File_write_at_all(R_MPI_File fh, R_MPI_Offset offset, const void *buf,
                                          int count, R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_File_iread_at(R_MPI_File fh, R_MPI_Offset offset, void *buf,
                                      int count, R_MPI_Datatype datatype, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_File_iwrite_at(R_MPI_File fh, R_MPI_Offset offset, const void *buf,
                                       int count, R_MPI_Datatype datatype, R_MPI_Request *request);
...
OMPI_DECLSPEC  int R_PMPI_File_read_all(R_MPI_File fh, void *buf, int count,
                                      R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_File_write(R_MPI_File fh, const void *buf, int count,
                                   R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_File_write_all(R_MPI_File fh, const void *buf, int count,
                                       R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_File_iread(R_MPI_File fh, void *buf, int count,
                                   R_MPI_Datatype datatype, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_File_iwrite(R_MPI_File fh, const void *buf, int count,
                                    R_MPI_Datatype datatype, R_MPI_Request *request);
...
OMPI_DECLSPEC  int R_PMPI_File_read_shared(R_MPI_File fh, void *buf, int count,
                                         R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_File_write_shared(R_MPI_File fh, const void *buf, int count,
                                          R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_File_iread_shared(R_MPI_File fh, void *buf, int count,
                                          R_MPI_Datatype datatype, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_File_iwrite_shared(R_MPI_File fh, const void *buf, int count,
                                           R_MPI_Datatype datatype, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_File_read_ordered(R_MPI_File fh, void *buf, int count,
                                          R_MPI_Datatype datatype, R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_File_write_ordered(R_MPI_File fh, const void *buf, int count,
                                           R_MPI_Datatype datatype, R_MPI_Status *status);
...
OMPI_DECLSPEC  int R_PMPI_File_write_at_all_begin(R_MPI_File fh, R_MPI_Offset offset, const void *buf,
                                                int count, R_MPI_Datatype datatype);
OMPI_DECLSPEC  int R_PMPI_File_write_at_all_end(R_MPI_File fh, const void *buf, R_MPI_Status *status);
...
OMPI_DECLSPEC  int R_PMPI_File_write_all_begin(R_MPI_File fh, const void *buf, int count,
                                             R_MPI_Datatype datatype);
OMPI_DECLSPEC  int R_PMPI_File_write_all_end(R_MPI_File fh, const void *buf, R_MPI_Status *status);
...
OMPI_DECLSPEC  int R_PMPI_File_write_ordered_begin(R_MPI_File fh, const void *buf, int count,
                                                 R_MPI_Datatype datatype);
OMPI_DECLSPEC  int R_PMPI_File_write_ordered_end(R_MPI_File fh, const void *buf, R_MPI_Status *status);
...
OMPI_DECLSPEC  int R_PMPI_Gather(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                               void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                               int root, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Igather(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                               void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                               int root, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Gatherv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                void *recvbuf, const int recvcounts[], const int displs[],
                                R_MPI_Datatype recvtype, int root, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Igatherv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                void *recvbuf, const int recvcounts[], const int displs[],
                                R_MPI_Datatype recvtype, int root, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Get_address(const void *location, R_MPI_Aint *address);
OMPI_DECLSPEC  int R_PMPI_Get_count(const R_MPI_Status *status, R_MPI_Datatype datatype, int *count);
OMPI_DECLSPEC  int R_PMPI_Get_elements(const R_MPI_Status *status, R_MPI_Datatype datatype,
                                     int *count);
OMPI_DECLSPEC  int R_PMPI_Get_elements_x(const R_MPI_Status *status, R_MPI_Datatype datatype,
                                       R_MPI_Count *count);
OMPI_DECLSPEC  int R_PMPI_Get(void *origin_addr, int origin_count,
                            R_MPI_Datatype origin_datatype, int target_rank,
                            R_MPI_Aint target_disp, int target_count,
                            R_MPI_Datatype target_datatype, R_MPI_Win win);
OMPI_DECLSPEC  int R_PMPI_Get_accumulate(const void *origin_addr, int origin_count, R_MPI_Datatype origin_datatype,
                                       void *result_addr, int result_count, R_MPI_Datatype result_datatype,
                                       int target_rank, R_MPI_Aint target_disp, int target_count,
                                       R_MPI_Datatype target_datatype, R_MPI_Op op, R_MPI_Win win);
...
OMPI_DECLSPEC  int R_PMPI_Graph_create(R_MPI_Comm comm_old, int nnodes, const int index[],
                                     const int edges[], int reorder, R_MPI_Comm *comm_graph);
OMPI_DECLSPEC  int R_PMPI_Graph_get(R_MPI_Comm comm, int maxindex, int maxedges,
                                  int index[], int edges[]);
OMPI_DECLSPEC  int R_PMPI_Graph_map(R_MPI_Comm comm, int nnodes, const int index[], const int edges[],
                                  int *newrank);
...
OMPI_DECLSPEC  int R_PMPI_Group_difference(R_MPI_Group group1, R_MPI_Group group2,
                                         R_MPI_Group *newgroup);
OMPI_DECLSPEC  int R_PMPI_Group_excl(R_MPI_Group group, int n, const int ranks[],
                                   R_MPI_Group *newgroup);
OMPI_DECLSPEC  R_MPI_Group R_PMPI_Group_f2c(R_MPI_Fint group);
OMPI_DECLSPEC  int R_PMPI_Group_free(R_MPI_Group *group);
OMPI_DECLSPEC  int R_PMPI_Group_incl(R_MPI_Group group, int n, const int ranks[],
                                   R_MPI_Group *newgroup);
...
OMPI_DECLSPEC  int R_PMPI_Group_translate_ranks(R_MPI_Group group1, int n, const int ranks1[],
                                              R_MPI_Group group2, int ranks2[]);
OMPI_DECLSPEC  int R_PMPI_Group_union(R_MPI_Group group1, R_MPI_Group group2,
                                    R_MPI_Group *newgroup);
OMPI_DECLSPEC  int R_PMPI_Ibsend(const void *buf, int count, R_MPI_Datatype datatype, int dest,
                               int tag, R_MPI_Comm comm, R_MPI_Request *request);
...
OMPI_DECLSPEC  int R_PMPI_Info_delete(R_MPI_Info info, const char *key);
...
OMPI_DECLSPEC  int R_PMPI_Info_get(R_MPI_Info info, const char *key, int valuelen,
                                 char *value, int *flag);
...
OMPI_DECLSPEC  int R_PMPI_Info_get_valuelen(R_MPI_Info info, const char *key, int *valuelen,
                                          int *flag);
OMPI_DECLSPEC  int R_PMPI_Info_set(R_MPI_Info info, const char *key, const char *value);
...
OMPI_DECLSPEC  int R_PMPI_Irecv(void *buf, int count, R_MPI_Datatype datatype, int source,
                              int tag, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Irsend(const void *buf, int count, R_MPI_Datatype datatype, int dest,
                               int tag, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Isend(const void *buf, int count, R_MPI_Datatype datatype, int dest,
                              int tag, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Issend(const void *buf, int count, R_MPI_Datatype datatype, int dest,
                               int tag, R_MPI_Comm comm, R_MPI_Request *request);
...
OMPI_DECLSPEC  int R_PMPI_Keyval_free(int *keyval)
                                    __mpi_interface_deprecated__("R_MPI_Keyval_free is superseded by R_MPI_Comm_free_keyval in MPI-2.0");
OMPI_DECLSPEC  int R_PMPI_Lookup_name(const char *service_name, R_MPI_Info info, char *port_name);
...
OMPI_DECLSPEC  int R_PMPI_Mrecv(void *buf, int count, R_MPI_Datatype type,
                              R_MPI_Message *message, R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_Neighbor_allgather(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                           void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                                           R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Ineighbor_allgather(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                            void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                                            R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Neighbor_allgatherv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                            void *recvbuf, const int recvcounts[], const int displs[],
                                            R_MPI_Datatype recvtype, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Ineighbor_allgatherv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                             void *recvbuf, const int recvcounts[], const int displs[],
                                             R_MPI_Datatype recvtype, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Neighbor_alltoall(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                          void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                                          R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Ineighbor_alltoall(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                           void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                                           R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Neighbor_alltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[],  R_MPI_Datatype sendtype,
                                           void *recvbuf, const int recvcounts[], const int rdispls[], R_MPI_Datatype recvtype,
                                           R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Ineighbor_alltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[], R_MPI_Datatype sendtype,
                                            void *recvbuf, const int recvcounts[], const int rdispls[], R_MPI_Datatype recvtype,
                                            R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Neighbor_alltoallw(const void *sendbuf, const int sendcounts[], const R_MPI_Aint sdispls[], const R_MPI_Datatype sendtypes[],
                                           void *recvbuf, const int recvcounts[], const R_MPI_Aint rdispls[], const R_MPI_Datatype recvtypes[],
                                           R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Ineighbor_alltoallw(const void *sendbuf, const int sendcounts[], const R_MPI_Aint sdispls[], const R_MPI_Datatype sendtypes[],
                                            void *recvbuf, const int recvcounts[], const R_MPI_Aint rdispls[], const R_MPI_Datatype recvtypes[],
                                            R_MPI_Comm comm, R_MPI_Request *request);
...
OMPI_DECLSPEC  int R_PMPI_Pack_external(const char datarep[], const void *inbuf, int incount,
                                      R_MPI_Datatype datatype, void *outbuf,
                                      R_MPI_Aint outsize, R_MPI_Aint *position);
OMPI_DECLSPEC  int R_PMPI_Pack_external_size(const char datarep[], int incount,
                                           R_MPI_Datatype datatype, R_MPI_Aint *size);
OMPI_DECLSPEC  int R_PMPI_Pack(const void *inbuf, int incount, R_MPI_Datatype datatype,
                             void *outbuf, int outsize, int *position, R_MPI_Comm comm);
...
OMPI_DECLSPEC  int R_PMPI_Publish_name(const char *service_name, R_MPI_Info info,
                                     const char *port_name);
OMPI_DECLSPEC  int R_PMPI_Put(const void *origin_addr, int origin_count, R_MPI_Datatype origin_datatype,
                            int target_rank, R_MPI_Aint target_disp, int target_count,
                            R_MPI_Datatype target_datatype, R_MPI_Win win);
...
OMPI_DECLSPEC  int R_PMPI_Recv(void *buf, int count, R_MPI_Datatype datatype, int source,
                             int tag, R_MPI_Comm comm, R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_Reduce(const void *sendbuf, void *recvbuf, int count,
                               R_MPI_Datatype datatype, R_MPI_Op op, int root, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Ireduce(const void *sendbuf, void *recvbuf, int count,
                               R_MPI_Datatype datatype, R_MPI_Op op, int root, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Reduce_local(const void *inbuf, void *inoutbuf, int count,
                                     R_MPI_Datatype datatype, R_MPI_Op);
OMPI_DECLSPEC  int R_PMPI_Reduce_scatter(const void *sendbuf, void *recvbuf, const int recvcounts[],
                                       R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Ireduce_scatter(const void *sendbuf, void *recvbuf, const int recvcounts[],
                                        R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Reduce_scatter_block(const void *sendbuf, void *recvbuf, int recvcount,
                                             R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Ireduce_scatter_block(const void *sendbuf, void *recvbuf, int recvcount,
                                              R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Register_datarep(const char *datarep,
                                         R_MPI_Datarep_conversion_function *read_conversion_fn,
                                         R_MPI_Datarep_conversion_function *write_conversion_fn,
                                         R_MPI_Datarep_extent_function *dtype_file_extent_fn,
                                         void *extra_state);
...
OMPI_DECLSPEC  int R_PMPI_Rget(void *origin_addr, int origin_count, R_MPI_Datatype origin_datatype, 
                             int target_rank, R_MPI_Aint target_disp, int target_count, R_MPI_Datatype target_datatype,
                             R_MPI_Win win, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Rget_accumulate(const void *origin_addr, int origin_count, R_MPI_Datatype origin_datatype,
                                        void *result_addr, int result_count, R_MPI_Datatype result_datatype,
                                        int target_rank, R_MPI_Aint target_disp, int target_count, 
                                        R_MPI_Datatype target_datatype, R_MPI_Op op,
                                        R_MPI_Win win, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Rput(const void *origin_addr, int origin_count, R_MPI_Datatype origin_datatype,
                             int target_rank, R_MPI_Aint target_disp, int target_cout, 
                             R_MPI_Datatype target_datatype, R_MPI_Win win, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Rsend(const void *ibuf, int count, R_MPI_Datatype datatype, int dest,
                              int tag, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Rsend_init(const void *buf, int count, R_MPI_Datatype datatype,
                                   int dest, int tag, R_MPI_Comm comm,
                                   R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Scan(const void *sendbuf, void *recvbuf, int count,
                             R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Iscan(const void *sendbuf, void *recvbuf, int count,
                             R_MPI_Datatype datatype, R_MPI_Op op, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Scatter(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                                int root, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Iscatter(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                void *recvbuf, int recvcount, R_MPI_Datatype recvtype,
                                int root, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Scatterv(const void *sendbuf, const int sendcounts[], const int displs[],
                                 R_MPI_Datatype sendtype, void *recvbuf, int recvcount,
                                 R_MPI_Datatype recvtype, int root, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Iscatterv(const void *sendbuf, const int sendcounts[], const int displs[],
                                 R_MPI_Datatype sendtype, void *recvbuf, int recvcount,
                                 R_MPI_Datatype recvtype, int root, R_MPI_Comm comm, R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Send_init(const void *buf, int count, R_MPI_Datatype datatype,
                                  int dest, int tag, R_MPI_Comm comm,
                                  R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Send(const void *buf, int count, R_MPI_Datatype datatype, int dest,
                             int tag, R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Sendrecv(const void *sendbuf, int sendcount, R_MPI_Datatype sendtype,
                                 int dest, int sendtag, void *recvbuf, int recvcount,
                                 R_MPI_Datatype recvtype, int source, int recvtag,
                                 R_MPI_Comm comm,  R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_Sendrecv_replace(void * buf, int count, R_MPI_Datatype datatype,
                                         int dest, int sendtag, int source, int recvtag,
                                         R_MPI_Comm comm, R_MPI_Status *status);
OMPI_DECLSPEC  int R_PMPI_Ssend_init(const void *buf, int count, R_MPI_Datatype datatype,
                                   int dest, int tag, R_MPI_Comm comm,
                                   R_MPI_Request *request);
OMPI_DECLSPEC  int R_PMPI_Ssend(const void *buf, int count, R_MPI_Datatype datatype, int dest,
                              int tag, R_MPI_Comm comm);
...
OMPI_DECLSPEC  int R_PMPI_Status_c2f(const R_MPI_Status *c_status, R_MPI_Fint *f_status);
OMPI_DECLSPEC  int R_PMPI_Status_f2c(const R_MPI_Fint *f_status, R_MPI_Status *c_status);
...
OMPI_DECLSPEC  int R_PMPI_Test_cancelled(const R_MPI_Status *status, int *flag);
...
OMPI_DECLSPEC  int R_PMPI_Type_create_hindexed(int count, const int array_of_blocklengths[],
                                             const R_MPI_Aint array_of_displacements[],
                                             R_MPI_Datatype oldtype,
                                             R_MPI_Datatype *newtype);
...
OMPI_DECLSPEC  int R_PMPI_Type_create_indexed_block(int count, int blocklength,
                                                  ...
                                                  R_MPI_Datatype oldtype,
                                                  R_MPI_Datatype *newtype);
OMPI_DECLSPEC  int R_PMPI_Type_create_struct(int count, const int array_of_block_lengths[],
                                           const R_MPI_Aint array_of_displacements[],
                                           const R_MPI_Datatype array_of_types[],
                                           R_MPI_Datatype *newtype);
OMPI_DECLSPEC  int R_PMPI_Type_create_subarray(int ndims, const int size_array[], const int subsize_array[],
                                             const int start_array[], int order,
                                             R_MPI_Datatype oldtype, R_MPI_Datatype *newtype);
...
OMPI_DECLSPEC  int R_PMPI_Type_hvector(int count, int blocklength, R_MPI_Aint stride,
                                     R_MPI_Datatype oldtype, R_MPI_Datatype *newtype)
                                     __mpi_interface_deprecated__("R_MPI_Type_hvector is superseded by R_MPI_Type_create_hvector in MPI-2.0");
OMPI_DECLSPEC  int R_PMPI_Type_indexed(int count, const int array_of_blocklengths[],
                                     const int array_of_displacements[],
                                     R_MPI_Datatype oldtype, R_MPI_Datatype *newtype);
...
OMPI_DECLSPEC  int R_PMPI_Type_set_attr(R_MPI_Datatype type, int type_keyval,
                                      void *attr_val);
OMPI_DECLSPEC  int R_PMPI_Type_set_name(R_MPI_Datatype type, const char *type_name);
...
OMPI_DECLSPEC  int R_PMPI_Type_vector(int count, int blocklength, int stride,
                                    R_MPI_Datatype oldtype, R_MPI_Datatype *newtype);
OMPI_DECLSPEC  int R_PMPI_Unpack(const void *inbuf, int insize, int *position,
                               void *outbuf, int outcount, R_MPI_Datatype datatype,
                               R_MPI_Comm comm);
OMPI_DECLSPEC  int R_PMPI_Unpublish_name(const char *service_name, R_MPI_Info info,
                                       const char *port_name);
OMPI_DECLSPEC  int R_PMPI_Unpack_external (const char datarep[], const void *inbuf, R_MPI_Aint insize,
                                         R_MPI_Aint *position, void *outbuf, int outcount,
                                         R_MPI_Datatype datatype);
...
OMPI_DECLSPEC  int R_PMPI_Win_set_name(R_MPI_Win win, const char *win_name);
...
OMPI_DECLSPEC  int R_PMPI_T_cvar_get_index (const char *name, int *cvar_index);
...
OMPI_DECLSPEC  int R_PMPI_T_cvar_write (R_MPI_T_cvar_handle handle, const void *buf);
...
OMPI_DECLSPEC  int R_PMPI_T_category_get_index (const char *name, int *category_index);
...
OMPI_DECLSPEC  int R_PMPI_T_pvar_get_index (const char *name, int var_class, int *pvar_index);
...
OMPI_DECLSPEC  int R_MPI_T_cvar_get_info (int cvar_index, char *name, int *name_len,
                                        ...
                                        R_MPI_T_enum *enumtype, char *desc,
                                        int *desc_len, int *bind, int *scope);
OMPI_DECLSPEC  int R_MPI_T_cvar_get_index (const char *name, int *cvar_index);
...
OMPI_DECLSPEC  int R_MPI_T_cvar_write (R_MPI_T_cvar_handle handle, const void *buf);
...
OMPI_DECLSPEC  int R_MPI_T_category_get_info(int cat_index, char *name, int *name_len,
                                           char *desc, int *desc_len, int *num_cvars,
                                           int *num_pvars, int *num_categories);
OMPI_DECLSPEC  int R_MPI_T_category_get_index (const char *name, int *category_index);
...
OMPI_DECLSPEC  int R_MPI_T_pvar_get_info(int pvar_index, char *name, int *name_len,
                                       ...
                                       R_MPI_T_enum *enumtype, char *desc, int *desc_len, int *bind,
                                       int *readonly, int *continuous, int *atomic);
OMPI_DECLSPEC  int R_MPI_T_pvar_get_index (const char *name, int var_class, int *pvar_index);
