...
typedef CCC_mpi_status_struct A_MPI_Status;
...
#if OA_MPI_PROVIDE_A_MPI_FILE_INTERFACE
...
#endif /* #if OA_MPI_PROVIDE_A_MPI_FILE_INTERFACE */
 ...
 */
#define A_MPI_INFO_ENV OA_MPI_PREDEFINED_GLOBAL(A_MPI_Info, ompi_mpi_info_env)
...
#define A_MPI_CONVERSION_FN_NULL ((A_MPI_Datarep_conversion_function*) 0)
 ...
 extern struct ompi_predefined_datatype_t ompi_mpi_lb __mpi_interface_deprecated__("A_MPI_LB is deprecated in MPI-2.0");
 extern struct ompi_predefined_datatype_t ompi_mpi_ub __mpi_interface_deprecated__("A_MPI_UB is deprecated in MPI-2.0");
...
/* New datatypes from the MPI 2.2 standard */
 ...
 extern A_MPI_Fint *A_MPI_F_STATUS_IGNORE;
 extern A_MPI_Fint *A_MPI_F_STATUSES_IGNORE;
...
#define A_MPI_COUNT                 OA_MPI_PREDEFINED_GLOBAL(A_MPI_Datatype, ompi_mpi_count)

#define A_MPI_ERRORS_ARE_FATAL OA_MPI_PREDEFINED_GLOBAL(A_MPI_Errhandler, ompi_mpi_errors_are_fatal)
#define A_MPI_ERRORS_RETURN OA_MPI_PREDEFINED_GLOBAL(A_MPI_Errhandler, ompi_mpi_errors_return)
 ...
 */
#if !defined(OA_MPI_SKIP_MPICXX) && OA_MPI_BUILD_CXX_BINDINGS && !OA_MPI_BUILDING
#if defined(c_plusplus) || defined(__cplusplus)
#include "openmpi/ompi/mpi/cxx/mpicxx.h"
#endif
#endif

#if !OA_MPI_PROVIDE_A_MPI_FILE_INTERFACE && !OA_MPI_BUILDING
