/* By Adrien Cotte with generator/FORTRAN/MPI_XXX_generator/MPC */
...
#define R_f_MPI_ERR_UNSUPPORTED_OPERATION 42

#define R_f_MPI_ERR_QUOTA 48

#define A_f_MPI_ERR_PORT 43

#define R_f_MPI_ERR_NO_SUCH_FILE 43

#define A_f_MPI_ERR_SIZE 49

#define R_f_MPI_ERR_READ_ONLY 49

#define A_f_MPI_ERR_UNSUPPORTED_OPERATION 52

#define R_f_MPI_ERR_CONVERSION 52

#define A_f_MPI_ERR_WIN 53

#define R_f_MPI_ERR_IO 53

#define A_f_MPI_ERR_BASE 24

#define R_f_MPI_ERR_INFO_VALUE 24

#define A_f_MPI_ERR_CONVERSION 25

#define R_f_MPI_ERR_INFO_NOKEY 25

#define A_f_MPI_ERR_DISP 26

#define R_f_MPI_ERR_SPAWN 26

#define A_f_MPI_ERR_DUP_DATAREP 27

#define R_f_MPI_ERR_PORT 27

#define A_f_MPI_ERR_ACCESS 20

#define R_f_MPI_ERR_KEYVAL 20

#define A_f_MPI_ERR_AMODE 21

#define R_f_MPI_ERR_NO_MEM 21

#define A_f_MPI_ERR_ASSERT 22

#define R_f_MPI_ERR_BASE 22

#define A_f_MPI_ERR_BAD_FILE 23

#define R_f_MPI_ERR_INFO_KEY 23

#define A_f_MPI_ERR_RMA_CONFLICT 46

#define R_f_MPI_ERR_ACCESS 46

#define A_f_MPI_ERR_RMA_SYNC 47

#define R_f_MPI_ERR_NO_SPACE 47

#define A_f_MPI_ERR_QUOTA 44

#define R_f_MPI_ERR_FILE_EXISTS 44

#define A_f_MPI_ERR_READ_ONLY 45

#define R_f_MPI_ERR_BAD_FILE 45

#define A_f_MPI_ERR_FILE_EXISTS 28

#define A_f_MPI_ERR_FILE_IN_USE 29

#define R_f_MPI_ERR_NAME 29

#define A_f_MPI_ERR_NOT_SAME 40

#define R_f_MPI_ERR_AMODE 40

#define A_f_MPI_ERR_NO_SPACE 41

#define R_f_MPI_ERR_UNSUPPORTED_DATAREP 41
...
#define R_f_MPI_ERR_DUP_DATAREP 51

#define A_f_MPI_ERR_NO_MEM 39

#define R_f_MPI_ERR_NOT_SAME 39

#define A_f_MPI_ERR_NAME 38

#define R_f_MPI_ERR_FILE 38
...
#define R_f_MPI_ERR_SIZE 31

#define A_f_MPI_ERR_FILE 30

#define R_f_MPI_ERR_WIN 30

#define A_f_MPI_ERR_LOCKTYPE 37

#define R_f_MPI_ERR_RMA_SYNC 37

#define A_f_MPI_ERR_KEYVAL 36

#define R_f_MPI_ERR_RMA_CONFLICT 36

#define A_f_MPI_ERR_IO 35

#define R_f_MPI_ERR_ASSERT 35

#define A_f_MPI_ERR_INFO 34

#define R_f_MPI_ERR_LOCKTYPE 34

#define A_f_MPI_ERR_INFO_VALUE 33

#define R_f_MPI_ERR_INFO 33

#define R_f_MPI_ERR_LASTCODE 74

#define A_f_MPI_ERR_INFO_NOKEY 32

#define R_f_MPI_ERR_DISP 32

#define A_f_MPI_ERR_SPAWN 50

#define R_f_MPI_ERR_FILE_IN_USE 50
...
#define R_f_MPI_DOUBLE_COMPLEX 4082

#define R_f_MPI_COMPLEX 4076

#define R_f_MPI_2REAL 4084

#define R_f_MPI_2INTEGER 4083

#define A_f_MPI_2DOUBLE_PRECISION 24

#define R_f_MPI_INTEGER1 24

#define A_f_MPI_2INTEGER 25

#define R_f_MPI_INTEGER2 25

#define R_f_MPI_INTEGER4 26

#define A_f_MPI_DOUBLE_COMPLEX 22

#define R_f_MPI_LOGICAL 22

#define A_f_MPI_2REAL 23

#define R_f_MPI_REAL4 28

#define R_f_MPI_REAL8 29
...
#define R_f_MPI_INTEGER 55

#define A_f_MPI_COMPLEX 18

#define R_f_MPI_DOUBLE_PRECISION 57

#define R_f_MPI_REAL 56

#define R_f_MPI_DATATYPE_NULL -1

#define R_f_MPI_LB -3

#define R_f_MPI_CHARACTER 54

#define R_f_MPI_2DOUBLE_PRECISION 4077
...
#define R_f_MPI_MINLOC 10

#define A_f_MPI_MINLOC 12

#define R_f_MPI_OP_NULL -1
...
#define R_f_MPI_SUM 0

#define A_f_MPI_SUM 3

#define R_f_MPI_PROD 3
...
#define R_f_MPI_BAND 5

#define A_f_MPI_PROD 4

#define R_f_MPI_LAND 4

#define A_f_MPI_LOR 7

#define R_f_MPI_BOR 7

#define A_f_MPI_BAND 6

#define R_f_MPI_LOR 6

#define A_f_MPI_LXOR 9

#define R_f_MPI_BXOR 9

#define A_f_MPI_BOR 8

#define R_f_MPI_LXOR 8
...
#define R_f_MPI_COMBINER_HVECTOR (5)
#define R_f_MPI_COMBINER_INDEXED (6)
#define R_f_MPI_COMBINER_HINDEXED (7)
#define R_f_MPI_COMBINER_INDEXED_BLOCK (8)
#define R_f_MPI_COMBINER_STRUCT (10)
#define R_f_MPI_COMBINER_DARRAY (12)
#define R_f_MPI_COMBINER_F90_REAL (13)
#define R_f_MPI_COMBINER_F90_COMPLEX (14)
#define R_f_MPI_COMBINER_F90_INTEGER (15)
#define R_f_MPI_COMBINER_RESIZED (16)
...
#define R_f_MPI_GROUP_EMPTY 0

#define R_f_MPI_GROUP_NULL -1
...
#define R_f_MPI_ERRORS_RETURN -6

#define A_f_MPI_ERRORS_ARE_FATAL 1

#define A_f_MPI_ERRHANDLER_NULL 0

#define R_f_MPI_ERRORS_ARE_FATAL -7

#define A_f_MPI_ERRORS_RETURN 2

#define R_f_MPI_ERRHANDLER_NULL -1
...
static inline void err_handler_a2r(int *ca, int *cr) {
  if (A_f_MPI_ERRORS_ARE_FATAL == *ca) {
    ...
    *cr = (int)R_f_MPI_ERRHANDLER_NULL;
    return;
  } else if (A_f_MPI_ERRORS_RETURN == *ca) {
...
#define R_f_MPI_UNDEFINED -1

#define R_f_MPI_GRAPH -3
...
#define R_f_MPI_WIN_DISP_UNIT 3

#define A_f_MPI_IO 2

#define R_f_MPI_WIN_SIZE 2
...
#define R_f_MPI_LASTUSEDCODE 6

#define A_f_MPI_WIN_DISP_UNIT 9

#define A_f_MPI_LASTUSEDCODE 5

#define R_f_MPI_UNIVERSE_SIZE 5
...
#define R_f_MPI_ORDER_FORTRAN 201

#define R_f_MPI_ORDER_C 200
...
#define R_f_MPI_DISTRIBUTE_NONE 1
...
#define R_f_MPI_DISTRIBUTE_CYCLIC 102

#define R_f_MPI_DISTRIBUTE_DFLT_DARG 100

#define R_f_MPI_DISTRIBUTE_BLOCK 101
...
static inline void order2_a2r(int *ca, int *cr) {
  if (A_f_MPI_DISTRIBUTE_CYCLIC == *ca) {
    ...
    *cr = (int)R_f_MPI_DISTRIBUTE_NONE;
    return;
  } else if (A_f_MPI_DISTRIBUTE_DFLT_DARG == *ca) {
...
static inline void order2_r2a(int *ca, int *cr) {
  if (R_f_MPI_DISTRIBUTE_NONE == *cr) {
    ...
    *ca = (int)A_f_MPI_DISTRIBUTE_CYCLIC;
    return;
  } else if (R_f_MPI_DISTRIBUTE_DFLT_DARG == *cr) {
