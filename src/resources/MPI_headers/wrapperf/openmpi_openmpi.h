...
#define A_f_MPI_COMBINER_NAMED (0)
#define A_f_MPI_COMBINER_DUP (1)
#define A_f_MPI_COMBINER_CONTIGUOUS (2)
#define A_f_MPI_COMBINER_VECTOR (3)
#define A_f_MPI_COMBINER_HVECTOR (5)
#define A_f_MPI_COMBINER_INDEXED (6)
#define A_f_MPI_COMBINER_HINDEXED (8)
#define A_f_MPI_COMBINER_INDEXED_BLOCK (9)
#define A_f_MPI_COMBINER_STRUCT (11)
#define A_f_MPI_COMBINER_DARRAY (13)
#define A_f_MPI_COMBINER_F90_REAL (14)
#define A_f_MPI_COMBINER_F90_COMPLEX (15)
#define A_f_MPI_COMBINER_F90_INTEGER (16)
#define A_f_MPI_COMBINER_RESIZED (17)

#define R_f_MPI_COMBINER_NAMED (0)
#define R_f_MPI_COMBINER_DUP (1)
#define R_f_MPI_COMBINER_CONTIGUOUS (2)
#define R_f_MPI_COMBINER_VECTOR (3)
#define R_f_MPI_COMBINER_HVECTOR (5)
#define R_f_MPI_COMBINER_INDEXED (6)
#define R_f_MPI_COMBINER_HINDEXED (8)
#define R_f_MPI_COMBINER_INDEXED_BLOCK (9)
#define R_f_MPI_COMBINER_STRUCT (11)
#define R_f_MPI_COMBINER_DARRAY (13)
#define R_f_MPI_COMBINER_F90_REAL (14)
#define R_f_MPI_COMBINER_F90_COMPLEX (15)
#define R_f_MPI_COMBINER_F90_INTEGER (16)
#define R_f_MPI_COMBINER_RESIZED (17)
...
static inline void err_handler_r2a(int *ca, int *cr) {
  if (R_f_MPI_ERRORS_ARE_FATAL == *cr) {
    ...
    *ca = (int)A_f_MPI_ERRHANDLER_NULL;
    return;
  } else if (R_f_MPI_ERRORS_RETURN == *cr) {
...
static inline void message_r2a(int *ca, int *cr) {
  if (R_f_MPI_MESSAGE_NO_PROC == *cr) {
    *ca = (int)A_f_MPI_MESSAGE_NO_PROC;
    return;
  } else if (R_f_MPI_MESSAGE_NULL == *cr) {
