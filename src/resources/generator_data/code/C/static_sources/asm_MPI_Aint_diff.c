...
__asm__(".global CCMPI_Aint_diff\n"
#else
__asm__(".global PMPI_Aint_diff\n"
        ".weak MPI_Aint_diff\n"
        ".set MPI_Aint_diff,PMPI_Aint_diff\n"
#endif

        ".extern in_w\n"
        ".extern A__MPI_Aint_diff\n"
        ".extern R__MPI_Aint_diff\n"
#if defined(_INTEL) || defined(_OMPI) || defined(_MPC)
        ...
        "jmp *A__MPI_Aint_diff@GOTPCREL(%rip)\n"
        "inwrap_MPI_Aint_diff:\n"
        "jmp *R__MPI_Aint_diff@GOTPCREL(%rip)\n"
#endif
#if defined(_INTEL) || defined(_OMPI) || defined(_MPC)
        ".size CCMPI_Aint_diff,.-CCMPI_Aint_diff\n"
#else
