...
def header_license_file():
    ...
    string=string+'//#   - Juilly Kevin <kevin.juilly.tgcc@cea.fr>                          #'+'\n'
    string=string+'//#                                                                      #'+'\n'
    string=string+'//########################################################################'+'\n'
...
def generate_wrapper_c(object_gen, wrapper, ompi_const, not_generated, def_list, data, init_conf,not_generated_ptr, root, list_not_gen=['MPI_Errhandler_set','MPI_Errhandler_get','MPI_Errhandler_free','MPI_Comm_create_errhandler','MPI_Comm_get_errhandler','MPI_Comm_set_errhandler']):
    ...
    if not wrapper:
        ...
        string=string+str_preload_api_fige
...
def generate_interface_f(object_gen, data2,data_f,def_list_f,static_list=["OMPI","INTEL"]):
    ...
    for i in data_f:
        for j in def_list_f: 
            if i['name'].lstrip().rstrip() == j.lstrip().rstrip():
                ...
                string=string+'#endif /*WI4MPI_STATIC*/\n'
    string=string+'#ifdef WI4MPI_STATIC\n'
    string=string+'#if defined(IFORT_CALL) || defined(PGI_CALL) || defined(FLANG_CALL) || (defined(GFORT_CALL) && __GNUC__ < 8)\n'
    ...
    string=string+'#else\n'    
    string=string+'#if defined(GFORT_CALL) && __GNUC__ >= 8\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Error_string)(int *, char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Get_processor_name)(char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_File_open)(int *, char *, int *, int *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_File_set_view)(int *, int *, int *, int *, char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_File_get_view)(int *, int *, int *, int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_File_delete)(char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Info_delete)(int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Info_get)(int *, char *, int *, char *, int *, int *, size_t, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Info_get_nthkey)(int *, int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Info_get_valuelen)(int *, char *, int *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Info_set)(int *, char *, char *, int *, size_t, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Win_get_name)(int *, char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Win_set_name)(int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Comm_spawn)(char *, char *, int *, int *, int *, int *, int *, int *, int *, size_t, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Comm_get_name)(int *, char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Comm_set_name)(int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Type_get_name)(int *, char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Type_set_name)(int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Add_error_string)(int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Close_port)(char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Get_library_version)(char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_OMPI_A_f_MPI_Open_port)(int *, char *, int *, size_t);\n'
    ...
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Error_string)(int *, char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Get_processor_name)(char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_File_open)(int *, char *, int *, int *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_File_set_view)(int *, int *, int *, int *, char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_File_get_view)(int *, int *, int *, int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_File_delete)(char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Info_delete)(int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Info_get)(int *, char *, int *, char *, int *, int *, size_t, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Info_get_nthkey)(int *, int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Info_get_valuelen)(int *, char *, int *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Info_set)(int *, char *, char *, int *, size_t, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Win_get_name)(int *, char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Win_set_name)(int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Comm_spawn)(char *, char *, int *, int *, int *, int *, int *, int *, int *, size_t, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Comm_get_name)(int *, char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Comm_set_name)(int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Type_get_name)(int *, char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Type_set_name)(int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Add_error_string)(int *, char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Close_port)(char *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Get_library_version)(char *, int *, int *, size_t);\n'
    string=string+'extern void (INTERF_2_INTEL_A_f_MPI_Open_port)(int *, char *, int *, size_t);\n'
