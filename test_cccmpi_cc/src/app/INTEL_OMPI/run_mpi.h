...
#define OR_MPI_WANT_R_MPI_INTERFACE_WARNING 0
#endif
...
typedef struct ompi_status_public_t R_MPI_Status;
...
#if !defined(OR_MPI_COMPILING_F77_WRAPPERS)
...
/* R_MPI_CONVERSION_FN_NULL is a sentinel value, but it has to be large
   ...
   therefore shares many characteristics between Fortran ants and
 ...
 */
#if !defined(OR_MPI_SKIP_MPICXX) && OR_MPI_WANT_CXX_BINDINGS && !OR_MPI_BUILDING
#if defined(c_plusplus) || defined(__cplusplus)
