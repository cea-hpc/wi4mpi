...
#define A_MPI_MAX_NAME_LEN         512     /* max port name length, non-std. (LAM < 6.3b1) */
...
A_MPI_Group A_MPI_GROUP_NULL=0x0;
A_MPI_Comm A_MPI_COMM_NULL=0x0;
A_MPI_Request A_MPI_REQUEST_NULL=0x0;
A_MPI_Op A_MPI_OP_NULL=0x0;
A_MPI_Errhandler A_MPI_ERRHANDLER_NULL=0x0;
A_MPI_Info A_MPI_INFO_NULL=0x0;
A_MPI_Win A_MPI_WIN_NULL=0x0;
A_MPI_File A_MPI_FILE_NULL=0x0;
A_MPI_Comm A_MPI_COMM_WORLD=0x1;
A_MPI_Comm A_MPI_COMM_SELF=0x2;
A_MPI_Group A_MPI_GROUP_EMPTY=0x1;
A_MPI_Op A_MPI_MAX=1;
A_MPI_Op A_MPI_MIN=2;
A_MPI_Op A_MPI_SUM=3;
A_MPI_Op A_MPI_PROD=4;
A_MPI_Op A_MPI_LAND=5;
A_MPI_Op A_MPI_BAND=6;
A_MPI_Op A_MPI_LOR=7;
A_MPI_Op A_MPI_BOR=8;
A_MPI_Op A_MPI_LXOR=9;
A_MPI_Op A_MPI_BXOR=10;
A_MPI_Op A_MPI_MAXLOC=11;
A_MPI_Op A_MPI_MINLOC=12;
A_MPI_Op A_MPI_REPLACE=13;
A_MPI_Datatype A_MPI_DATATYPE_NULL=0;
A_MPI_Datatype A_MPI_BYTE=1;
A_MPI_Datatype A_MPI_PACKED=2;
A_MPI_Datatype A_MPI_CHAR=3;
A_MPI_Datatype A_MPI_SHORT=4;
A_MPI_Datatype A_MPI_INT=5;
A_MPI_Datatype A_MPI_LONG=6;
A_MPI_Datatype A_MPI_FLOAT=7;
A_MPI_Datatype A_MPI_DOUBLE=8;
A_MPI_Datatype A_MPI_LONG_DOUBLE=9;
A_MPI_Datatype A_MPI_UNSIGNED_CHAR=10;
A_MPI_Datatype A_MPI_SIGNED_CHAR=11;
A_MPI_Datatype A_MPI_UNSIGNED_SHORT=12;
A_MPI_Datatype A_MPI_UNSIGNED_LONG=13;
A_MPI_Datatype A_MPI_UNSIGNED=14;
A_MPI_Datatype A_MPI_FLOAT_INT=15;
A_MPI_Datatype A_MPI_DOUBLE_INT=16;
A_MPI_Datatype A_MPI_LONG_DOUBLE_INT=17;
A_MPI_Datatype A_MPI_LONG_INT=18;
A_MPI_Datatype A_MPI_SHORT_INT=19;
A_MPI_Datatype A_MPI_2INT=20;
A_MPI_Datatype A_MPI_UB=21;
A_MPI_Datatype A_MPI_LB=22;
A_MPI_Datatype A_MPI_WCHAR=23;
A_MPI_Datatype A_MPI_LONG_LONG_INT=24;
A_MPI_Datatype A_MPI_LONG_LONG=25;
A_MPI_Datatype A_MPI_UNSIGNED_LONG_LONG=26;
A_MPI_Datatype A_MPI_2COMPLEX=27;
A_MPI_Datatype A_MPI_2DOUBLE_COMPLEX=28;
A_MPI_Datatype A_MPI_CHARACTER=29;
A_MPI_Datatype A_MPI_LOGICAL=30;
A_MPI_Datatype A_MPI_LOGICAL1=31;
A_MPI_Datatype A_MPI_LOGICAL2=32;
A_MPI_Datatype A_MPI_LOGICAL4=33;
A_MPI_Datatype A_MPI_LOGICAL8=34;
A_MPI_Datatype A_MPI_INTEGER=35;
A_MPI_Datatype A_MPI_INTEGER1=36;
A_MPI_Datatype A_MPI_INTEGER2=37;
A_MPI_Datatype A_MPI_INTEGER4=38;
A_MPI_Datatype A_MPI_INTEGER8=39;
A_MPI_Datatype A_MPI_INTEGER16=40;
A_MPI_Datatype A_MPI_REAL=41;
A_MPI_Datatype A_MPI_REAL4=42;
A_MPI_Datatype A_MPI_REAL8=43;
A_MPI_Datatype A_MPI_REAL16=44;
A_MPI_Datatype A_MPI_DOUBLE_PRECISION=45;
A_MPI_Datatype A_MPI_COMPLEX=46;
A_MPI_Datatype A_MPI_COMPLEX8=47;
A_MPI_Datatype A_MPI_COMPLEX1=48;
A_MPI_Datatype A_MPI_COMPLEX32=49;
A_MPI_Datatype A_MPI_DOUBLE_COMPLEX=50;
A_MPI_Datatype A_MPI_2REAL=51;
A_MPI_Datatype A_MPI_2DOUBLE_PRECISION=52;
A_MPI_Datatype A_MPI_2INTEGER=53;
A_MPI_Datatype A_MPI_INT8_T=54;
A_MPI_Datatype A_MPI_UINT8_T=55;
A_MPI_Datatype A_MPI_INT16_T=56;
A_MPI_Datatype A_MPI_UINT16_T=57;
A_MPI_Datatype A_MPI_INT32_T=58;
A_MPI_Datatype A_MPI_UINT32_T=59;
A_MPI_Datatype A_MPI_INT64_T=60;
A_MPI_Datatype A_MPI_UINT64_T=61;
A_MPI_Datatype A_MPI_AINT=62;
A_MPI_Datatype A_MPI_OFFSET=63;
A_MPI_Datatype A_MPI_C_BOOL=64;
A_MPI_Datatype A_MPI_C_COMPLEX=65;
A_MPI_Datatype A_MPI_C_FLOAT_COMPLEX=66;
A_MPI_Datatype A_MPI_C_DOUBLE_COMPLEX=67;
A_MPI_Datatype A_MPI_C_LONG_DOUBLE_COMPLEX=68;
A_MPI_Errhandler A_MPI_ERRORS_ARE_FATAL=1;
A_MPI_Errhandler A_MPI_ERRORS_RETURN=2;
...
int A_MPI_Issend(void *buf, int count, A_MPI_Datatype datatype, int dest,
  ...
  int A_MPI_Pack_size(int incount, A_MPI_Datatype datatype, A_MPI_Comm comm,
                                 int *size);
  int A_MPI_Pcontrol(const int level, ...);
...
int A_PMPI_Irsend(void *buf, int count, A_MPI_Datatype datatype, int dest,
  ...
  int A_PMPI_Pack_size(int incount, A_MPI_Datatype datatype, A_MPI_Comm comm,
                                  int *size);
  int A_PMPI_Pcontrol(const int level, ...);
